...
FROM bank.order
WHERE k_symbol <> "" -- added this to prevent some existing empty values
--? QUESTION: I didn't understand the part in the instructions about the order table not existing.
...
ORDER BY date DESC
LIMIT 10 
--* NOTE: in the readme trans 3556467 and 233395 appear in different order, both are the same date
...
--? QUESTION: Why this gives me more rows than the ones in the instructions. Dates from dec 26 to dec 31.
